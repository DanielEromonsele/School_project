...
import Personal from "../pages/page/stats/Personal";
    ...
    <div className="text-blue-950 flex flex-col h-full">
      <div className=" grid grid-cols-1 lg:grid-cols-2 gap-3 mt-5">
        <div className="min-w-[250px] h-full flex flex-col rounded-md border p-4">
          <div className="mb-4 text-medium capitalize">Student's Info</div>
          <Personal />
          ...
          <div className=" rounded-md w-full  p-4">
            ...
            <div>
              {readData?.length > 0 ? (
                ...
                <div className="flex flex-col w-full items-center">
                  <MdPlaylistAddCheck size={30} />
                  <p className="font-medium text-[13px]">No Entry Record yet</p>
                </div>
              )}
            </div>
          </div>
